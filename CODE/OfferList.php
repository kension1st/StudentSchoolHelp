...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php 
      ...
      include 'koneksi.php';
      $no = 1;
      $data = mysqli_query($koneksi,"select offer.*, user.*, volunteer.* from offer INNER JOIN user ON offer.userID=user.userID INNER JOIN volunteer ON offer.userID=volunteer.userID Where offer.requestID=$requestID");
    ...
    <tr>
      ...
      <td><?php echo $d['occupation']; ?></td>
      <td><a href="AccOffer.php?offerID=<?php echo  $d['offerID'];?>">ACCEPTED</a></td>
    </tr>
